...
public class SpecController {
     ...
     * @return
     */
    @GetMapping("/findSpecByCategoryName")
    public Result findSpecByCategoryName(String name) {
        return new Result(true, StatusCode.OK, "查询成功", specService.findSpecByCategoryName(name));
    }
