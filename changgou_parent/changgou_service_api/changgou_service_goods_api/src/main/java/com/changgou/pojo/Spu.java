...
public class Spu implements Serializable {
    //是否上架,0为不上架,1,表示上架
    public static final String NOTISMARKETABLE = "0";
    public static final String YESISMARKETABLE = "1";
    //是否删除 0表示不删除,1表示删除
    public static final String NOTISDELETE = "0";
    public static final String YSEISDELETE = "1";
    //是否审核通过
    public static final String YSTATUS = "1";
    public static final String NSTATUS = "0";
    public static final String CSTATUS = "2";
